            ...
            <div class="container">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="userName" class="col-md-2 control-label">产品名</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="userName" id="userName" placeholder="产品名">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 input-group">
                            <input type="text" class="form-control inputdate" name="minBirthday" id="minBirthday"
                                   aria-describedby="basic-addon3">
                            <span class="input-group-addon">--</span>
                            <input type="text" class="form-control inputdate" name="maxBirthday" id="maxBirthday"
                                   aria-describedby="basic-addon3">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default" onclick="getDate(1);">提交</button>
...
<div id="addUserShowDiv">
    <form class="form-horizontal" id="userWhereForm">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 input-group">
                <span class="input-group-addon">--</span>
                <input type="text" class="form-control" id="userNameSerch">
            </div>
        </div>
        <div class="form-group">
...
<script>
    ...
    function initTable() {
        ...
        var node = zTreeObj.transformToArray(nodes);
        var ids = [];
    ...
    function initZtreeClone() {
        $.ajax({
            ...
            success: function (data) {
                ...
                zTreeObject = $.fn.zTree.init($("#ztreeUl"), settings, data.data);
    ...
    function getDate() {
        table.settings()[0].ajax.data = {
            "ids": deptIds,
            "userName":$("#userNameSerch").val(),
            "minBirthday":$("#minBirthday").val(),
            "maxBirthday":$("#maxBirthday").val(),
        ...
        if (checkboxStauts.length > 0) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var replaceZtree = $.fn.zTree.init($("#ztreeReplaceZtree"), settings, result.data);
                    bootbox.dialog({
                        title: 'A custom dialog with buttons and callbacks',
                        message: $("#ztreeDiv ul"),
                        size: 'large',
